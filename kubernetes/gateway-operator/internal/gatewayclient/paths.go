...
const (
	...
	webSubAPIsPath           = ManagementAPIBasePath + "/websub-apis"
...
const (
	...
	ApiKeyParentKindWebSubApi   = "WebSubApi"
)
...
func apiKeyParentPath(kind string) (string, error) {
	...
	case ApiKeyParentKindWebSubApi:
		return webSubAPIsPath, nil
	default:
...
// WebSubAPIsPath returns the configured /websub-apis base path.
func WebSubAPIsPath() string { return webSubAPIsPath }
