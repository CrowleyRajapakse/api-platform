...
// +kubebuilder:validation:XValidation:rule="self.expiresAt == null || self.expiresIn == null",message="expiresAt and expiresIn are mutually exclusive"
type ApiKeySpec struct {
	...
	// Mutually exclusive with ExpiresAt; if both are set ExpiresAt wins.
	// +optional
