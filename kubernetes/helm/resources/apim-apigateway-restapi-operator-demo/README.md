...
```bash
kubectl get llmprovidertemplate,llmprovider,llmproxy,mcp,websubapi,managedsecret,certificate,apikey,subscriptionplan,subscription -n apigateway-demo-apim
```
